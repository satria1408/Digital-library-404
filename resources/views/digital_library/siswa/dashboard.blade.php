...
@section('content')
<div class="container-fluid py-3 px-3 px-md-4" x-data="{ openPerpus: false }">
    ...
    <div class="row g-4 justify-content-center mb-4">
        ...
        <div class="col-12 col-md-6 col-lg-5 order-1 order-md-1">
            <div @click="openPerpus = !openPerpus" class="card h-100 border-0 text-decoration-none bg-white p-4 luxury-hub-card cursor-pointer" style="border-radius: 20px;">
        ...
        <!-- DROPDOWN MODUL PERPUS: order-2 di mobile (nempel di bawah Perpus), order-md-3 di desktop (turun ke bawah full-width) -->
