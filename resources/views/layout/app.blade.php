...
href="{{ route('books.index') }}">Kelola Buku</a> 
                        </li> 
                        <li class="nav-item"> 
                            <a class="nav-link {{ request()->routeIs('users.*') ? 'active' : '' }}" 
href="{{ route('users.index') }}">Kelola Anggota</a> 
                        </li> 
                        <li class="nav-item"> 
...
}}" href="{{ route('siswa.dashboard') }}">Dashboard & Peminjaman</a> 
                        </li> 
                    @endif 
                ...
                <div class="d-flex align-items-center"> 
                    <span class="navbar-text text-white me-3"> 
                        ...
                        <span class="badge bg-light text-primary ms-1">{{ ucfirst(Auth::user()->role) 
}}</span> 
                    </span> 
